...
const NJSLogPrinter = new lib.NJSLogPrinter({
  context: {},
  printError: message => console.log('Error', message),
  printInfo: message => console.log('Info', message),
  printDebug: message => console.log('Debug', message),
  printWarning: message => console.log('Warning', message),
  printApdu: message => console.log('Apdu', message),
  printCriticalError: message => console.log('CriticalError', message),
